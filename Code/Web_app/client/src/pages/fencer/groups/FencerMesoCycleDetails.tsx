...
import MesoCycleAddPlan from "../../mesocycle/MesoCycleAddPlan";
import MesoCycleMicroLoad from "../../mesocycle//MesoCycleMicroLoad";

const FencerMesoCycleDetails = () => {
  const { id } = useParams();
...
export default FencerMesoCycleDetails;
